 ...
 * Output: [2, 4]
 * Explanation:
 * All letters except 'a' have the same length of 10, and "bbbcccdddaa" will cover 9 * 10 + 2 * 4 = 98 units. For the
 * last 'a', it is written on the second line because there is only 2 units left in the first line. So the answer is 2
 * lines, plus 4 units in the second line.
 * 
 * Note:
...
public class NumberOfLinesToWriteString {
    ...
    public static void main(String[] args) {
        ...
        int[] ans = new NumberOfLinesToWriteString().new Solution().numberOfLines(widths, s);
        System.out.println(Arrays.toString(ans));
    }

    /**
     * What kind of question is this?? Come on LeetCode...
     * 
     * Time complexity: O(n)
     */
    class Solution {
